import { IProjectData, ITechRequest, IUserAddress, IUserLogin } from "../../interfaces/users";
// import { IScheduleRequest } from "../../interfaces/schedules";
// import { IPropertyRequest } from "../../interfaces/properties";
// import { ICategoryRequest } from "../../interfaces/categories";

export const mockedUser: IUserAddress = {
    street: "Rua Teste",
    state: "SP",
    user: {
        name: "Joana",
...
export const mockedAdmin: IUserAddress = {
    street: "Rua Admin",
    state: "RJ",
    user: {
        name: "Felipe",
...
export const mockedTechnology: ITechRequest = {
    name: "Javascript",
};

export const mockedProject: IProjectData = {
    name: "Projeto 1",
